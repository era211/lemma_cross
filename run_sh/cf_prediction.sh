...
nohup python -u c_prediction_v1.py --train ${train} --gpu_num ${gpu_num} --batch_size ${batch_size} --out_dir ${output_dir} --save_model_path ${save_model_path}\
