...
parser.add_argument('--gpu_num', type=int, default=1, help=' A single GPU number')
...
parser.add_argument('--max_sentence_len', default=100, type=int, help='max sentence length')
